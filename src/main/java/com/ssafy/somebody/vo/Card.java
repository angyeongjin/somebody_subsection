...
public class Card {
	...
	public String toString() {
		return "Card [purchase_corp=" + purchase_corp + ", purchase_corp_code=" + purchase_corp_code + ", issuer_corp="
				+ issuer_corp + ", issuer_corp_code=" + issuer_corp_code + ", bin=" + bin + ", card_type=" + card_type
