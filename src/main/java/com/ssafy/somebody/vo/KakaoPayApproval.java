...
public class KakaoPayApproval {
	...
	public KakaoPayApproval(String aid, String tid, String cid, String sid, String partner_order_id,
	...
	public String toString() {
		return "KakaoPayApproval [aid=" + aid + ", tid=" + tid + ", cid=" + cid + ", sid=" + sid + ", partner_order_id="
